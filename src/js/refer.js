export function referFreind() {
        ...
        containers.forEach(container => {
            ...
            input.addEventListener("input", (e) => {
                ...
                if (e.target.type === "email") {
                    colorize(validateEmail(e.target.value) ? '#6391E8' : '#FE8C99', line, placeholder);
                }
            });
        });
    ...
    function efect() {
        ...
        refer_freind.addEventListener("mousemove", (detls) => {
        ...
        refer_freind.addEventListener("mouseleave", () => {
            gsap.to(refer_card, {
                x: 0,
                y: 0,
                ease: "power4",
